...
switch decoder
    case 'MF'
        ...
        pow_signal_hat = norm(signal_hat(:),2)^2/(n_user*n_block);         % Received signal power calculation
        
        signal_hat = sqrt(ref_pow/pow_signal_hat)*signal_hat;              % Received signal power normalization
        
        varargout{1} = decod_mtx;
        varargout{2} = pow_signal_hat;
    case 'ZF'
