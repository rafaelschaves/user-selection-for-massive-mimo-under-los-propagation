...
MC = 20000;                                                                % Size of the monte-carlo ensemble
...
for chn_idx = 1:N_CHN
    for m = 1:M_SIZ
        for snr_idx = 1:N_SNR
            load([root_load '/rate_mf_' chn_type{chn_idx} '_M_' num2str(M(m)) ...
                  '_K_' num2str(K) '_L_' num2str(L) '_theta_mid_' ...
                  num2str(180*theta_mid/pi) '_theta_step_' ...
                  num2str(180*theta_step/pi) '_SNR_' num2str(snr(snr_idx)) ...
